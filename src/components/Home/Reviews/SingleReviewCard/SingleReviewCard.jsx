...
const SingleReviewCard = ({ review }) => {
  ...
  return (
    <div
      ...
      className="bg-[#E3FFE5] pt-[12px] lg:pt-[20px] xl:pt-[26px] 2xl:pt-[31px] pb-[30px] sm:pb-[38px] lg:pb-[45px] xl:pb-[60px] 2xl:pb-[90px] pl-[12px] lg:pl-[20px] xl:pl-[24px] 2xl:pl-[27px] pr-[16px] xl:pr-[28px] 2xl:pr-[34px] rounded-[16px] lg:rounded-[25px] xl:rounded-[36px] 2xl:rounded-[40px] relative"
    >
      {/* profile */}
