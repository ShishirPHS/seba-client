...
const WhyChoose = () => {
  return (
    <div className="container mx-auto mb-[46px] lg:mb-[90px] xl:mb-[115px] 2xl:mb-[142px] mt-[56px] lg:mt-[90px] xl:mt-[100px] 2xl:mt-[114px] px-5">
      {/* title */}
      <h3 className="text-[#232222] text-[16px] lg:text-[34px] xl:text-[44px] 2xl:text-5xl font-semibold font-poppins leading-[123%] mx-auto text-center">
        Why Choose Seba?
      </h3>
      {/* img div */}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="col-span-1 rounded-[17px] px-[43px] lg:px-5 xl:px-[30px] py-[20px] lg:py-4 xl:py-[18px] bg-[#086060] w-full md:w-auto">
          <p className="font-poppins text-base xl:text-lg 2xl:text-2xl font-medium leading-[123%] text-white text-center md:text-left max-w-[300px] md:max-w-none mx-auto">
            Country First Doctor Patients Relation Management System
          </p>
        </div>
        {/* bottom middle */}
        <div className="col-span-1 rounded-[17px] pl-[72px] lg:pl-5 xl:pl-[62px] 2xl:pl-[72px] pr-[64px] lg:pr-[20px] xl:pr-[52px] 2xl:pr-[64px] py-[20px] lg:py-4 xl:py-[18px] bg-[#F4F4F4] w-full md:w-auto">
          <p className="font-poppins text-base xl:text-lg 2xl:text-2xl font-medium leading-[123%] text-black text-center md:text-left max-w-[243px] md:max-w-none mx-auto">
        ...
        <div className="col-span-1 rounded-[17px] px-[80px] lg:px-[20px] xl:px-[60px] py-[18px] lg:py-4 xl:py-[18px] bg-[#FF0068] w-full md:w-auto">
          <p className="font-poppins text-base xl:text-lg 2xl:text-2xl font-medium leading-[123%] text-white text-center md:text-left max-w-[220px] md:max-w-none mx-auto">
