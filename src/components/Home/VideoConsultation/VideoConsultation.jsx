      ...
      <Container>
        <div className="flex justify-between relative mx-5">
          <div className="bg-primary pt-[3px] sm:pt-[9px] lg:pt-[10px] xl:pt-[12px] 2xl:pt-[17px] pb-[5px] sm:pb-[11px] lg:pb-3 xl:pb-[12px] 2xl:pb-[20px] px-[6px] sm:px-[12px] lg:px-5 xl:px-[34px] 2xl:px-[40px] rounded-[5px] sm:rounded-[10px] lg:rounded-[12px] xl:rounded-[16px] 2xl:rounded-[20px]">
            ...
            />
            <h3 className="text-white text-center font-poppins text-[5px] sm:text-[10px] lg:text-sm xl:text-base 2xl:text-xl font-medium  mt-[3px] sm:mt-[6px] lg:mt-1 xl:mt-[10px] 2xl:mt-[13px]">
              Labs
            </h3>
          </div>
          <div className="bg-primary pt-[3px] sm:pt-[9px] lg:pt-[10px] xl:pt-[12px] 2xl:pt-[17px] pb-[5px] sm:pb-[11px] lg:pb-3 xl:pb-[12px] 2xl:pb-[20px] px-[6px] sm:px-[12px] lg:px-5 xl:px-[34px] 2xl:px-[40px] rounded-[5px] sm:rounded-[10px] lg:rounded-[12px] xl:rounded-[16px] 2xl:rounded-[20px]">
            <img
              ...
              alt="icon for test-tube"
            />
            <h3 className="text-white text-center font-poppins text-[5px] sm:text-[10px] lg:text-sm xl:text-base 2xl:text-xl font-medium leading-[123%] mt-[3px] sm:mt-[6px] lg:mt-1 xl:mt-[10px] 2xl:mt-[13px]">
              Hospitals
            </h3>
          </div>
