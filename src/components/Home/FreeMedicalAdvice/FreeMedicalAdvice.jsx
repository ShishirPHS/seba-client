    ...
    <div className="container mx-auto px-5">
      <div className="flex flex-col md:flex-row gap-[28px] md:gap-[78px]">
        ...
        <div className="flex flex-col pt-[47px] md:pt-[72px] px-[80px] md:px-[118px] bg-[#FF0068] rounded-[24px] md:rounded-[40px] flex-shrink-0 relative overflow-hidden">
          <h3 className="text-[19px] md:text-4xl font-bold text-white font-poppins leading-[123%] inline-block mx-auto relative z-50">
            Video Consultation
          </h3>
          <p className="font-poppins text-[16px] md:text-2xl font-normal leading-[123%] text-white inline-block mx-auto mb-[410px] md:mb-0 relative z-50">
            Verified Doctors
          </p>
