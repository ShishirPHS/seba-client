...
const FreeMedicalAdvice = () => {
  return (
    <div className="container mx-auto px-5">
      <div className="flex flex-col md:flex-row gap-[28px] lg:gap-[30px] xl:gap-[78px]">
        {/* left */}
        <div className="flex flex-col pt-[47px] lg:pt-[50px] xl:pt-[72px] px-[80px] lg:px-[75px] xl:px-[118px] bg-[#FF0068] rounded-[24px] md:rounded-[40px] flex-shrink-0 relative overflow-hidden">
          ...
          <div className="w-[319px] md:w-[341px] h-[372px] md:h-[372px] mt-[21px] md:mt-[33px] absolute left-[50%] transform -translate-x-[50%] bottom-0">
            <img
              className="scale-[160%] lg:scale-[100%] xl:scale-[145%]"
              src={img1}
              alt=""
            />
          </div>
        ...
        <div className="flex flex-col gap-[23px] md:gap-[51px] w-full">
          ...
          <div className="bg-[#3BA4A7] rounded-[24px] md:rounded-[40px] pl-[32px] md:pl-[70px] pr-[76px] pt-[24px] md:pt-[54px] pb-[25px] md:pb-[58px] relative">
            <h3 className="text-white font-poppins text-[9px] lg:text-lg xl:text-2xl font-bold leading-[123%] mb-[10px] md:mb-[21px] max-w-[162px] md:max-w-[418px]">
          ...
          <div className="bg-[#1F1F1F] rounded-[24px] md:rounded-[40px] pt-[23px] md:pt-[53px] pb-[23px] md:pb-[50px] pl-[32px] md:pl-[70px] relative">
            <h3 className="max-w-[100px] md:max-w-[259px] text-white font-poppins text-[9px] lg:text-lg xl:text-2xl font-bold leading-[123%]">
