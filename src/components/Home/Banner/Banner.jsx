      ...
      <Container>
        <div className="relative overflow-hidden">
          <div className="sm:mx-5">
            {/* banner left */}
            <div className="mb-[70px] sm:mb-[52px] md:mb-[70px] lg:mb-[70px] xl:mb-[130px] bg-white rounded-[40px] lg:rounded-[30px] xl:rounded-[40px] pt-[23px] lg:pt-[30px] xl:pt-[39px] pb-[23px] lg:pb-[25px] xl:pb-[40px] px-6 sm:px-7 lg:px-[25px] xl:px-[44px] mt-[64px] sm:mt-[48px] md:mt-[64px] lg:mt-[80px] xl:mt-[150px] w-full md:w-[50%] relative z-20">
              <h1 className="mb-[25px] sm:mb-[18px] md:mb-[25px] lg:mb-[30px] xl:mb-[50px] font-poppins text-[20px] md:text-[24px] lg:text-[30px] xl:text-[38px] text-center md:text-left font-bold max-w-[226px] sm:max-w-[220px] lg:max-w-[320px] xl:max-w-[412px] leading-[123%] block md:inline-block mx-auto">
                Find the Best Doctor Near You
              </h1>
              <form className="border border-[#808080] rounded-[25px] lg:rounded-[30px] xl:rounded-[40px]">
                <div className="border-b border-[#808080] relative pt-[10px] sm:pt-[4px] md:pt-[10px] lg:pt-[10px] xl:pt-[20px] pr-[8px] sm:px-2 lg:px-[12px] xl:px-[32px] pb-[2px] lg:pb-[6px] xl:pb-[8px]">
                  <input
                    type="text"
                  ...
                  />
                  <img
                    className="w-[19px] lg:w-[24px] h-[19px] md:h-[33px] absolute right-[16px] sm:right-[25px] lg:right-[28px] xl:right-[40px] top-[40%] lg:top-[50%] xl:top-[52%] lg:transform lg:-translate-y-[42%] cursor-pointer"
                    src={locationIcon}
                    alt="a icon of location"
                  />
                </div>
                <div className="border-b border-[#808080] flex justify-between sm:pt-[4px] md:pt-[8px] lg:pt-[10px] xl:pt-[20px] pr-[16px] sm:pl-[8px] sm:pr-[25px] lg:pl-[12px] lg:pr-[28px] xl:pl-[32px] xl:pr-[40px] pb-[2px] lg:pb-[6px] xl:pb-[20px] gap-[5px] lg:gap-[10px] xl:gap-[24px]">
            ...
            <div>
              <img
                className="hidden md:block absolute bottom-0 right-0 w-[456px] lg:w-[510px] xl:w-[780px]"
                src={bannerImg}
                alt="banner image"
              />
            </div>
