      ...
      <Container>
        <div className="relative overflow-hidden">
          <div className="sm:mx-5">
            {/* banner left */}
            <div className="mb-[70px] sm:mb-[52px] md:mb-[70px] lg:mb-[70px] xl:mb-[130px] 2xl:mb-[156px] bg-white rounded-[40px] lg:rounded-[30px] xl:rounded-[40px] pt-[23px] lg:pt-[30px] xl:pt-[39px] 2xl:pt-[49px] pb-[23px] lg:pb-[25px] xl:pb-[40px] px-6 sm:px-7 lg:px-[25px] xl:px-[44px] 2xl:px-16 mt-[64px] sm:mt-[48px] md:mt-[64px] lg:mt-[80px] xl:mt-[150px] 2xl:mt-[177px] w-full md:w-[50%] relative z-20">
              <h1 className="mb-[25px] sm:mb-[18px] md:mb-[25px] lg:mb-[30px] xl:mb-[50px] 2xl:mb-[62px] font-poppins text-[20px] md:text-[24px] lg:text-[30px] xl:text-[38px] 2xl:text-[48px] text-center md:text-left font-bold max-w-[226px] sm:max-w-[220px] lg:max-w-[320px] xl:max-w-[412px] 2xl:max-w-[490px] leading-[123%] block md:inline-block mx-auto">
                Find the Best Doctor Near You
              </h1>
              <form className="border border-[#808080] rounded-[25px] lg:rounded-[30px] xl:rounded-[40px]">
                <div className="border-b border-[#808080] relative pt-[10px] sm:pt-[4px] md:pt-[10px] lg:pt-[10px] xl:pt-[20px] 2xl:pt-[48px] pr-[8px] sm:px-2 lg:px-[12px] xl:px-[32px] pb-[2px] lg:pb-[6px] xl:pb-[8px] 2xl:pb-[20px]">
                  <input
                    type="text"
                ...
                <div className="border-b border-[#808080] flex justify-between sm:pt-[4px] md:pt-[8px] lg:pt-[10px] xl:pt-[20px] 2xl:pt-[38px] pr-[16px] sm:pl-[8px] sm:pr-[25px] lg:pl-[12px] lg:pr-[28px] xl:pl-[32px] xl:pr-[40px] 2xl:pr-[55px] pb-[2px] lg:pb-[6px] xl:pb-[20px] 2xl:pb-[30px] gap-[5px] lg:gap-[10px] xl:gap-[24px] 2xl:gap-[100px]">
