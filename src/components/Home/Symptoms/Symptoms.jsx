...
const Symptoms = () => {
  ...
  return (
    <>
      <Container>
        <div className="mt-[38px] lg:mt-[95px] xl:mt-[105px] mb-[60px] lg:mb-[100px] xl:mb-[115px] px-5">
          {/* top */}
          <div className="flex justify-between mb-[35px] lg:mb-10 xl:mb-[49px]">
            <h2 className="text-black font-poppins text-lg sm:text-[22px] md:text-2xl xl:text-[34px] font-medium leading-[123%]">
              Symptoms
            </h2>
            <Link
              to="/"
              className="text-black font-poppins text-lg sm:text-[22px] md:text-2xl xl:text-[34px] font-medium leading-[123%] cursor-pointer"
            >
              View All
            </Link>
          </div>
          ...
          <div>
            ...
            <div className="hidden xl:flex flex-wrap gap-4 lg:gap-6 justify-between">
